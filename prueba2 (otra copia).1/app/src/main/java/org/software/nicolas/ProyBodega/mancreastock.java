...
public class mancreastock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String consulta = "http://10.251.151.81/ProyBodega/ventanastock/mostrarproducto.php";
        ...
        String visualid = "http://10.251.151.81/ProyBodega/ventanastock/generarid.php";
        ...
        listarproductos.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String consulta2 = "http://10.251.151.81/ProyBodega/ventanastock/buscarproducto.php?producto=" + listarproductos.getItemAtPosition(listarproductos.getSelectedItemPosition()).toString();
        ...
        nuevo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String consulta = "http://10.251.151.81/ProyBodega/ventanastock/generarid.php";
