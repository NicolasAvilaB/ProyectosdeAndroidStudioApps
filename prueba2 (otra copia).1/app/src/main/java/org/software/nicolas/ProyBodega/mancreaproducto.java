...
public class mancreaproducto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String consultas = "http://10.251.151.81/ProyBodega/ventanaprod/mostrarprod.php";
        ...
        buscar.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                {
                    String consultas = "http://10.251.151.81/ProyBodega/ventanaprod/buscar.php?producto="+buscar.getText().toString();
        ...
        nuevo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                codigo.requestFocus();
                String consulta = "http://10.251.151.81/ProyBodega/ventanaprod/generarid.php";
        ...
        eliminar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String consultas = "http://10.251.151.81/ProyBodega/ventanaprod/validararticulostock.php?codigo="+codigo.getText() + "&producto="+nombre.getText();
                consultas = consultas.replace(" ","%20");
                RequestQueue queue = Volley.newRequestQueue(mancreaproducto.this);
                StringRequest stringRequest = new StringRequest(Request.Method.GET, consultas , new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.length()>0){
                            ...
                            Toast.makeText(getApplicationContext(), "OJO: Para poder Eliminarlo Solo debes Dirigirte a la Seccion de Almacenamientos de Productos en Stock", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
            ...
            public void aceptar() {
                String registro = "http://10.251.151.81/ProyBodega/ventanaprod/eliminarprod.php?codigo=" + codigo.getText().toString();
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (varseleccion == 1) {
                    String registro = "http://10.251.151.81/ProyBodega/ventanaprod/registrarprod.php?id=" + id.getText().toString() + "&codigo=" + codigo.getText().toString() + "&nombre=" + nombre.getText().toString()+ "&marca="+ marca.getText().toString();
                    registro = registro.replace(" ","%20");
                    EnviarRecibirDatosl(registro);
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET, consultas, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if (response.length()>0){
                                ...
                                String registro = "http://10.251.151.81/ProyBodega/ventanaprod/modificarprod.php?codigo="+codigo.getText().toString()+"&nombre=" + nombre.getText().toString() + "&marca=" + marca.getText().toString() + "&id=" + id.getText().toString();
                                registro = registro.replace(" ","%20");
                                EnviarRecibirDatosl(registro);
