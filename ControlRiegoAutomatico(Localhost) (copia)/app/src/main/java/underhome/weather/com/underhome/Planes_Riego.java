...
public class Planes_Riego extends AppCompatActivity implements DialogoPlanRiego.FinalizoCuadroDialogo {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        valor_agua = valor;
        String consulta4 = "http://192.168.43.250/sistemariego_app/mostrar_suelos_comp.php?t=" + valor;
    ...
    public void ResultadoCuadroDialogo(boolean res) {
        valor = res;
        if (valor){
            String consulta_motor = "http://192.168.43.250/sistemariego_app/comprobar_motor_agua.php";
            EnviarRecibirDatos_Ejecucion_Motor(consulta_motor);
        } else if(valor == false){
        }
    }
    ...
    public void EnviarDatos_Historiales(String URL) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                DHT11 h = new DHT11();
                h.ejecutarsnack();
                String consulta3 = "http://192.168.43.250/sistemariego_app/mostrar_planes_riego.php";
                h.EnviarRecibirDatos3(consulta3);
                String consulta4 = "http://192.168.43.250/sistemariego_app/mostrar_suelos.php";
    ...
    public void CargarDatos_Clima(JSONArray ja){
            try{
                ...
                if (ll.equals("Llovisna")){
                    ...
                    String consulta4 = "http://192.168.43.250/sistemariego_app/mostrar_suelos_comp.php?t=" + valor_agua;
                    consulta4 = consulta4.replace(" ", "%20");
    ...
    public void EnviarRecibirDatos_Ejecucion_Motor(String URL) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                response = response.replace("][", ",");
                if (response.length() > 0) {
                    mostrarsnack = Snackbar.make(findViewById(R.id.volver), "Advertencia: Las plantas ya se estan regando", Snackbar.LENGTH_LONG).setAction("Action", null);
                    View sbView = mostrarsnack.getView();
                    sbView.setBackgroundColor(Color.rgb(13, 112, 110));
                    mostrarsnack.show();
                }else {
                    ...
                    String registro0 = "http://192.168.43.250/sistemariego_app/ingreso_historial_riego_suelo.php?t=" + idees2 + "&t2=" + cu2 + "&t3=" + pl2 + "&t4=" + ho2 + "&t5=" + fe2 + "&t6=" + su2 + "&t7=" + ab2 + "&t8=" + ti2;
