...
public class DHT11 extends AppCompatActivity
            ...
            public void onRefresh() {
                ...
                (new Handler()).postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String consulta5 = "http://192.168.43.250/sistemariego_app/mostrar_sensores.php";
    ...
    public void ResultadoCuadroDialogo (boolean res){
        ...
        if (valor){
            ...
            String registro0 = "http://192.168.43.250/sistemariego_app/sesiones/ingreso_cierre_sesion.php?ids="+suma+"&nombre="+operario.getText();
