...
public class Invernaderos extends AppCompatActivity implements DialogoEliminar.FinalizoCuadroDialogo {

    Button nuevo, eliminar, modificar, guardar, cancelar, busqueda;
    Snackbar mostrarsnack;
    EditText ID, INVERNADERO, TIPOCULTIVO, TIPOSUELO, ABONO, BUSCAR;
    TextInputLayout INVERNADERO1, TIPOCULTIVO1, TIPOSUELO1, ABONO1, BUSCAR1;
    ...
    private RecyclerView recyclerinvernaderos;
    private RecyclerViewAdapter_invernaderos adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_invernaderos);
        setTitle("Gestion Invernaderos");
        ...
        recyclerinvernaderos = findViewById(R.id.recyclerinvernaderos);
        tarjetainvernaderos = findViewById(R.id.tarjetainvernaderos);
        actualizar_datos();
        ...
        nuevo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BUSCAR.setText("");
                progressBarbuscar= new ProgressDialog(Invernaderos.this);
                ...
                String consulta2 = "http://192.168.43.250/sistemariego_app_admin/maninvernadero/generar_id.php";
        ...
        eliminar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                BUSCAR1.setError(null);
                new DialogoEliminar(mensaje_flotante_eliminando, Invernaderos.this);
            }});
    ...
    public void guardar_datos(){
        if (INVERNADERO.getText().length() == 0) {
            INVERNADERO1.setError("Advertencia: Campo Invernadero Vacio");
        }
        else{
            INVERNADERO1.setError(null);
            Pattern patron = Pattern.compile("^[a-zA-Z ]+$");
            if (!patron.matcher(INVERNADERO.getText()).matches() || INVERNADERO.getText().length() > 45) {
        ...
        if (TIPOSUELO.getText().length() == 0){
            ...
            if (!patron3.matcher(TIPOSUELO.getText()).matches() || TIPOSUELO.getText().length() > 45) {
        ...
        if (ABONO.getText().length() == 0){
            ...
            if (!patron4.matcher(ABONO.getText()).matches() || ABONO.getText().length() > 45) {
        ...
        TIPOCULTIVO1.setError("Comprobando Cultivo...");
        String consulta2 = "http://192.168.43.250/sistemariego_app_admin/maninvernadero/buscar.php?n=" + INVERNADERO.getText();
    ...
    public void buscar_datos(){
        if (BUSCAR.getText().length() == 0){
            ...
            mostrarsnack.show();
            String consulta2 = "http://192.168.43.250/sistemariego_app_admin/maninvernadero/buscar.php?n=" + BUSCAR.getText();
            consulta2 = consulta2.replace(" ","%20");
    ...
    public void actualizar_datos(){
        ...
        sbView.setBackgroundColor(Color.rgb(13,112,110));
        mostrarsnack.show();
        String consulta2 = "http://192.168.43.250/sistemariego_app_admin/mostrar_registros_invernaderos.php";
        EnviarRecibirDatos(consulta2);
    }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.length()>0){
                    ...
                    mostrarsnack = Snackbar.make(findViewById(R.id.nuevo), "No hay Datos de Invernaderos", Snackbar.LENGTH_LONG).setAction("Action", null);
                    View sbView = mostrarsnack.getView();
                    sbView.setBackgroundColor(Color.rgb(13,112,110));
                    mostrarsnack.show();
                }
    ...
    public void CargarDatos_Invernaderos(JSONArray ja){
        try{
            int a = 0;
            ID.setText(""+ja.getString(a));
            INVERNADERO.setText(""+ja.getString(a+1));
            TIPOCULTIVO.setText(""+ja.getString(a+2));
            TIPOSUELO.setText(""+ja.getString(a+3));
            ABONO.setText(""+ja.getString(a+4));
        }catch (JSONException e){
            e.printStackTrace();
        }
        listadata4.clear();
        ejecutar_recyclerview_invernaderos();
        for(int i=0;i<ja.length();i+=5){
            try{
                listadata4.add(new Data4("ID: "+ja.getString(i),"Invernadero: "+ja.getString(i+1),"Tipo Cultivo: "+ja.getString(i+2), "Tipo Suelo: "+ja.getString(i+3), "Abono: "+ja.getString(i+4)));
            }catch (JSONException e){
                e.printStackTrace();
            }
            //animarcardviews_ver();
    ...
    public void ejecutar_recyclerview_invernaderos(){
        recyclerinvernaderos.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(Invernaderos.this);
        recyclerinvernaderos.setLayoutManager(layoutManager);
        adapter = new RecyclerViewAdapter_invernaderos(listadata4);
        recyclerinvernaderos.setAdapter(adapter);
    }
    ...
    public void CargarDatos_Suelo2(JSONArray ja){
        ...
        listadata4.clear();
        ejecutar_recyclerview_invernaderos();
        for(int i=0;i<ja.length()/*ja.length()*/;i+=5){
            try{
                listadata4.add(new Data4("ID: "+ja.getString(i),"Invernadero: "+ja.getString(i+1),"Tipo Cultivo: "+ja.getString(i+2), "Tipo Suelo: "+ja.getString(i+3), "Abono: "+ja.getString(i+4)));
            }catch (JSONException e){
                e.printStackTrace();
    ...
    public void ResultadoCuadroDialogo(boolean res) {
        ...
        if (valor == true){
            ...
            progressBarbuscar.setCancelable(false);
            progressBarbuscar.show();
            String registro0 = "http://192.168.43.250/sistemariego_app_admin/maninvernadero/eliminar_inv.php?i="+ID.getText();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.length()>0) {
                    try {
                        JSONArray ja = new JSONArray(response);
                        String invernaderos = ja.getString(1);
                        String cultivos = ja.getString(2);
                        if (invernaderos.equals(INVERNADERO.getText().toString()) && cultivos.equals(TIPOCULTIVO.getText().toString())) {
                            INVERNADERO1.setError("Advertencia: Invernadero ya existente en el Registro");
                            TIPOCULTIVO1.setError("Advertencia: Cultivo ya existente en el Registro");
    ...
    public void guardar_modificar(){
        if (varseleccion == 1){
            if(TIPOSUELO1.getError() == null && TIPOCULTIVO1.getError() == null && ABONO1.getError() == null && INVERNADERO1.getError() == null) {
                INVERNADERO1.setError(null);
                TIPOCULTIVO1.setError(null);
                TIPOSUELO1.setError(null);
                ABONO1.setError(null);
                ...
                progressBarbuscar.show();
                if (ABONO.getText().length() == 0){
                    String registro = "http://192.168.43.250/sistemariego_app_admin/maninvernadero/ingreso_inv.php?i=" + ID.getText() + "&n=" + INVERNADERO.getText() + "&cl=" + TIPOCULTIVO.getText() + "&c=" + TIPOSUELO.getText() + "&e=";
                    ...
                    String registro = "http://192.168.43.250/sistemariego_app_admin/maninvernadero/ingreso_inv.php?i=" + ID.getText() + "&n=" + INVERNADERO.getText() + "&cl=" + TIPOCULTIVO.getText() + "&c=" + TIPOSUELO.getText() + "&e=" + ABONO.getText();
                    registro = registro.replace(" ", "%20");
                    EnviarRecibirDatos2(registro);
                    varseleccion = 0;
                    refresco_datos.setEnabled(true);
            ...
            if(TIPOSUELO1.getError() == null && TIPOCULTIVO1.getError() == null && ABONO1.getError() == null && INVERNADERO1.getError() == null) {
                ...
                progressBarbuscar.show();
                if (ABONO.getText().length() == 0){
                    String registro = "http://192.168.43.250/sistemariego_app_admin/maninvernadero/modificar_inv.php?i=" + ID.getText() + "&n=" + INVERNADERO.getText() + "&cl=" + TIPOCULTIVO.getText() + "&c=" + TIPOSUELO.getText() + "&e=";
                    registro = registro.replace(" ", "%20");
                    EnviarRecibirDatos2(registro);
                    varseleccion = 0;
                    refresco_datos.setEnabled(true);
                    ...
                    String registro = "http://192.168.43.250/sistemariego_app_admin/maninvernadero/modificar_inv.php?i=" + ID.getText() + "&n=" + INVERNADERO.getText() + "&cl=" + TIPOCULTIVO.getText() + "&c=" + TIPOSUELO.getText() + "&e=" + ABONO.getText();
                    registro = registro.replace(" ", "%20");
                    EnviarRecibirDatos2(registro);
                    varseleccion = 0;
                    refresco_datos.setEnabled(true);
