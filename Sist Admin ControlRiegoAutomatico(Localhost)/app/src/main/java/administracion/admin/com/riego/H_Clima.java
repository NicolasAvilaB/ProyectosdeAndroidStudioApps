...
public class H_Clima extends AppCompatActivity {
    ...
    private RecyclerView recyclerhclima;
    private RecyclerViewAdapter_HCLIMA adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_h__clima);
        setTitle("Historial Clima");
        ...
        recyclerhclima = findViewById(R.id.recyclerhclima);
        ...
        fecha1.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View view, boolean b) {
                if (!b){
                    ...
                    dpd = new DatePickerDialog(H_Clima.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
            ...
            public void onClick(View view) {
                ...
                if (buscar.getText().length() == 0 && buscar.isEnabled())
                {
                    ...
                    else if (valor_seleccionado == "Filtro Normal" && buscar.isEnabled())
                    {
                        ...
                        til2.setError(null);
                        til3.setError(null);
                        progressBarbuscar = new ProgressDialog(H_Clima.this);
                        ...
                        String registro = "http://192.168.43.250/sistemariego_app_admin/buscar_hclima_normal.php?a=" + buscar.getText();
                        ...
                        progressBarbuscar.setCancelable(false);
                        progressBarbuscar.show();
                        String registro = "http://192.168.43.250/sistemariego_app_admin/buscar_hclima_fecha.php?a=" + fecha1.getText() +"&b=" + fecha2.getText();
                        registro = registro.replace(" ","%20");
                        EnviarRecibirDatos(registro);
                    }
                }
    ...
    public void CargarDatos(JSONArray ja){
        ...
        for(int i=0;i<ja.length();i+=7){
            try{
                listadatahclima.add(new Datahclima("ID: "+ja.getString(i),"Clima: "+ja.getString(i+1),"Resumen: "+ja.getString(i+2), "Temperatura: "+ja.getString(i+3), "Humedad: "+ja.getString(i+4), "Hora: "+ja.getString(i+5), "Fecha: "+ja.getString(i+6)));
            }catch (JSONException e){
                e.printStackTrace();
            }
            //animarcardviews_ver();
    ...
    public void ejecutar_recyclerview(){
        recyclerhclima.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(H_Clima.this);
        recyclerhclima.setLayoutManager(layoutManager);
        adapter = new RecyclerViewAdapter_HCLIMA(listadatahclima);
        recyclerhclima.setAdapter(adapter);
    }
