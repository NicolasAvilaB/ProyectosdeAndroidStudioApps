...
public class H_Riego extends AppCompatActivity {
    ...
    private RecyclerView recyclerhriego;
    private RecyclerViewAdapter_HRIEGO adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_h__riego);
        setTitle("Historial Riego");
        ...
        recyclerhriego = findViewById(R.id.recyclerhriego);
        ...
        fecha1.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View view, boolean b) {
                if (!b){
                    ...
                    dpd = new DatePickerDialog(H_Riego.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
            ...
            public void onClick(View view) {
                ...
                if (buscar.getText().length() == 0 && buscar.isEnabled())
                {
                    ...
                    else if (valor_seleccionado == "Filtro Normal" && buscar.isEnabled())
                    {
                        ...
                        til2.setError(null);
                        til3.setError(null);
                        progressBarbuscar = new ProgressDialog(H_Riego.this);
                        ...
                        String registro = "http://192.168.43.250/sistemariego_app_admin/buscar_hriego_normal.php?a=" + buscar.getText();
                        ...
                        EnviarRecibirDatos(registro);
                            ...
                            progressBarbuscar.setCancelable(false);
                            progressBarbuscar.show();
                            String registro = "http://192.168.43.250/sistemariego_app_admin/buscar_hriego_fecha.php?a=" + fecha1.getText() +"&b=" + fecha2.getText();
                            registro = registro.replace(" ","%20");
                            EnviarRecibirDatos(registro);
                    }
                }
    ...
    public void CargarDatos(JSONArray ja){
        ...
        for(int i=0;i<ja.length();i+=6){
            try{
                listadatahriego.add(new Datahriego("ID: "+ja.getString(i),"Tipo Cultivo: "+ja.getString(i+1),"Tipo Plan: "+ja.getString(i+2), "Hora: "+ja.getString(i+3), "Fecha: "+ja.getString(i+4), "Tiempo Regadio: "+ja.getString(i+5)));
            }catch (JSONException e){
                e.printStackTrace();
            }
            //animarcardviews_ver();
    ...
    public void ejecutar_recyclerview(){
        recyclerhriego.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(H_Riego.this);
        recyclerhriego.setLayoutManager(layoutManager);
        adapter = new RecyclerViewAdapter_HRIEGO(listadatahriego);
        recyclerhriego.setAdapter(adapter);
    }
