...
public class manadmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String consulta = "http://systemchile.com/AplicacionProyBodega/ventanaadmins/mostraradmins.php";
        ...
        buscar.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(buscar.getText().length()==0){
                    ...
                    String consulta = "http://systemchile.com/AplicacionProyBodega/ventanaadmins/buscar.php?alias=" + buscar.getText().toString();
    ...
    public void clicknuevo (View v) {
        ...
        String consulta = "http://systemchile.com/AplicacionProyBodega/ventanaadmins/generarid.php";
        RequestQueue queue = Volley.newRequestQueue(this);
    ...
    public void aceptar() {
        String registro = "http://systemchile.com/AplicacionProyBodega/ventanaadmins/eliminaradmin.php?alias=" + nombre_alias.getText().toString();
    ...
    public void clickguardar (View v) {
        if (varseleccion == 1) {
            String registro = "http://systemchile.com/AplicacionProyBodega/ventanaadmins/registraradmin.php?id=" + id.getText().toString() + "&alias=" + nombre_alias.getText().toString() + "&clave=" + clave_acceso.getText().toString();
            registro = registro.replace(" ","%20");
            EnviarRecibirDatos(registro);
            ...
            String registro = "http://systemchile.com/AplicacionProyBodega/ventanaadmins/modificaradmin.php?alias=" + nombre_alias.getText().toString() + "&clave=" + clave_acceso.getText().toString() + "&id=" + id.getText().toString();
            registro = registro.replace(" ","%20");
            EnviarRecibirDatos(registro);
